--Let's buy Rose a pair of Boots from ShoeShop. 
--So we have to update the Rose balance as well as the ShoeShop
--balance in the BankAccounts table. Then we also have to update 
--Boots stock in the ShoeShop table. After Boots, let's also attempt to buy Rose a pair of Trainers.
